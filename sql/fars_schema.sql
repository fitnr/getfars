...
CREATE TABLE fars.parkwork (
    ...
    ptype integer,
    phit_run integer references fars.hit_run (hit_run),
    preg_stat integer,
...
CREATE TABLE fars.pbtype (
    ...
    pbage integer,
    pbsex integer references fars.sex (sex),
    pbcwalk integer,
    pbswalk integer,
    pbszone integer,
...
CREATE TABLE fars.person (
    ...
    rest_use integer,
    rest_mis integer,
    air_bag integer references fars.air_bag (air_bag),
    ejection integer references fars.ejection (ejection),
    ej_path integer references fars.ejection_path (ej_path),
    extricat integer,
    drinking integer,
    alc_det integer references fars.method_alc_det (alc_det),
    alc_status integer references fars.alc_test (alc_status),
    atst_typ integer,
    alc_res integer,
    drugs integer,
    drug_det integer,
    ...
    hospital integer references fars.transported_treatment (hospital),
    doa integer,
    death_da integer,
    death_mo integer,
    death_yr integer,
    ...
    work_inj integer,
    hispanic integer  references fars.hispanic_origin (hispanic),
    race integer references fars.race (race),
...
CREATE TABLE fars.vehicle (
    ...
    man_coll integer references fars.manner_of_collision (man_coll),
    unittype integer,
    hit_run integer references fars.hit_run (hit_run),
    reg_stat integer,
