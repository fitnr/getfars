...
insert into fars.crash_group_bike values
    (0, 'Not a Cyclist'),
...
insert into fars.crash_group_pedestrian values
    (0, 'Not a Pedestrian'),
...
insert into fars.injury_severity values
...
insert into fars.restraint_use values
    (0, 'Not Applicable'),
    ...
    (97, 'Not a Motor Vehicle Occupant Other'),
    (98, 'Not Reported'),
    (99, 'Unknown');
...
insert into fars.accident_type values
    (0, 'No Impact'),
    (1, 'SINGLE DRIVER - RIGHT ROADSIDE DEPARTURE: Drive Off Road'),
    (2, 'SINGLE DRIVER - RIGHT ROADSIDE DEPARTURE: Control/Traction Loss'),
    (3, 'SINGLE DRIVER - RIGHT ROADSIDE DEPARTURE: Avoid Collision with Vehicle, Pedestrian, Animal'),
    (4, 'SINGLE DRIVER - RIGHT ROADSIDE DEPARTURE: Specifics Other'),
    (5, 'SINGLE DRIVER - RIGHT ROADSIDE DEPARTURE: Specifics Unknown'),
    (6, 'SINGLE DRIVER - LEFT ROADSIDE DEPARTURE: Drive Off Road'),
    (7, 'SINGLE DRIVER - LEFT ROADSIDE DEPARTURE: Control/Traction Loss'),
    (8, 'SINGLE DRIVER - LEFT ROADSIDE DEPARTURE: Avoid Collision With Vehicle, Pedestrian, Animal'),
    (9, 'SINGLE DRIVER - LEFT ROADSIDE DEPARTURE: Specifics Other'),
    (10, 'SINGLE DRIVER - LEFT ROADSIDE DEPARTURE: Specifics Unknown'),
    (11, 'SINGLE DRIVER - FORWARD IMPACT: Parked Vehicle'),
    (12, 'SINGLE DRIVER - FORWARD IMPACT: Stationary Object'),
    (13, 'SINGLE DRIVER - FORWARD IMPACT: Pedestrian/Animal'),
    (14, 'SINGLE DRIVER - FORWARD IMPACT: End Departure'),
    (15, 'SINGLE DRIVER - FORWARD IMPACT: Specifics Other'),
    (16, 'SINGLE DRIVER - FORWARD IMPACT: Specifics Unknown'),
    (20, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Stopped'),
    (21, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Stopped, Straight'),
    (22, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Stopped, Left'),
    (23, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Stopped, Right'),
    (24, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Slower'),
    (25, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Slower, Going Straight'),
    (26, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Slower, Going Left'),
    (27, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Slower, Going Right'),
    (28, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Decelerating (Slowing)'),
    (29, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Decelerating (Slowing), Going Straight'),
    (30, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Decelerating (Slowing), Going Left'),
    (31, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Decelerating (Slowing), Going Right'),
    (32, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Specifics Other'),
    (33, 'SAME TRAFFICWAY, SAME DIRECTION - REAR END: Specifics Unknown'),
    (34, 'SAME TRAFFICWAY, SAME DIRECTION - FORWARD IMPACT: This Vehicles Frontal Area Impacts Another Vehicle.'),
    (35, 'SAME TRAFFICWAY, SAME DIRECTION - FORWARD IMPACT: This Vehicle Is Impacted by Frontal Area of Another Vehicle'),
    (36, 'SAME TRAFFICWAY, SAME DIRECTION - FORWARD IMPACT: This Vehicles Frontal Area Impacts Another Vehicle.'),
    (37, 'SAME TRAFFICWAY, SAME DIRECTION - FORWARD IMPACT: This Vehicle Is Impacted by Frontal Area of Another Vehicle'),
    (38, 'SAME TRAFFICWAY, SAME DIRECTION - FORWARD IMPACT: This Vehicles Frontal Area Impacts Another Vehicle.'),
    (39, 'SAME TRAFFICWAY, SAME DIRECTION - FORWARD IMPACT: This Vehicle Is Impacted by Frontal Area of Another Vehicle'),
    (40, 'SAME TRAFFICWAY, SAME DIRECTION - FORWARD IMPACT: This Vehicles Frontal Area Impacts Another Vehicle.'),
    (41, 'SAME TRAFFICWAY, SAME DIRECTION - FORWARD IMPACT: This Vehicle Is Impacted by Frontal Area of Another Vehicle'),
    (42, 'SAME TRAFFICWAY, SAME DIRECTION - FORWARD IMPACT: Specifics Other'),
    (43, 'SAME TRAFFICWAY, SAME DIRECTION - FORWARD IMPACT: Specifics Unknown'),
    (44, 'SAME TRAFFICWAY, SAME DIRECTION - SIDESWIPE/ANGLE: Straight Ahead on Left.'),
    (45, 'SAME TRAFFICWAY, SAME DIRECTION - SIDESWIPE/ANGLE: Straight Ahead on Left/Right.'),
    (46, 'SAME TRAFFICWAY, SAME DIRECTION - SIDESWIPE/ANGLE: Changing Lanes to the Right'),
    (47, 'SAME TRAFFICWAY, SAME DIRECTION - SIDESWIPE/ANGLE: Changing Lanes to the Left'),
    (48, 'SAME TRAFFICWAY, SAME DIRECTION - SIDESWIPE/ANGLE: Specifics Other'),
    (49, 'SAME TRAFFICWAY, SAME DIRECTION - SIDESWIPE/ANGLE: Specifics Unknown'),
    (50, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - HEAD-ON: Lateral Move (Left/Right)'),
    (51, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - HEAD-ON: Lateral Move (Going Straight)'),
    (52, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - HEAD-ON: Specifics Other'),
    (53, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - HEAD-ON: Specifics Unknown'),
    (54, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - FORWARD IMPACT: This Vehicles Frontal Area Impacts Another Vehicle.'),
    (55, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - FORWARD IMPACT: This Vehicle Is Impacted by Frontal Area of Another Vehicle'),
    (56, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - FORWARD IMPACT: This Vehicles Frontal Area Impacts Another Vehicle.'),
    (57, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - FORWARD IMPACT: This Vehicle Is Impacted by Frontal Area of Another Vehicle'),
    (58, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - FORWARD IMPACT: This Vehicles Frontal Area Impacts Another Vehicle.'),
    (59, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - FORWARD IMPACT: This Vehicle Is Impacted by Frontal Area of Another Vehicle'),
    (60, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - FORWARD IMPACT: This Vehicles Frontal Area Impacts Another Vehicle.'),
    (61, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - FORWARD IMPACT: This Vehicle Is Impacted by Frontal Area of Another Vehicle'),
    (62, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - FORWARD IMPACT: Specifics Other'),
    (63, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - FORWARD IMPACT: Specifics Unknown'),
    (64, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - SIDESWIPE/ANGLE: Lateral Move (Left/Right)'),
    (65, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - SIDESWIPE/ANGLE: Lateral Move (Going Straight)'),
    (66, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - SIDESWIPE/ANGLE: Specifics Other'),
    (67, 'SAME TRAFFICWAY, OPPOSITE DIRECTION - SIDESWIPE/ANGLE: Specifics Unknown'),
    (68, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN ACROSS PATH: Initial Opposite Directions (Left/Right)'),
    (69, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN ACROSS PATH: Initial Opposite Directions (Going Straight)'),
    (70, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN ACROSS PATH: Initial Same Directions (Turning Right)'),
    (71, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN ACROSS PATH: Initial Same Directions (Going Straight)'),
    (72, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN ACROSS PATH: Initial Same Directions (Turning Left)'),
    (73, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN ACROSS PATH: Initial Same Directions (Going Straight)'),
    (74, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN ACROSS PATH: Specifics Other'),
    (75, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN ACROSS PATH: Specifics Unknown'),
    (76, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN INTO PATH: Turn Into Same Direction (Turning Left)'),
    (77, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN INTO PATH: Turn Into Same Direction (Going Straight)'),
    (78, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN INTO PATH: Turn Into Same Direction (Turning Right)'),
    (79, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN INTO PATH: Turn Into Same Direction (Going Straight)'),
    (80, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN INTO PATH: Turn Into Opposite Directions (Turning Right)'),
    (81, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN INTO PATH: Turn Into Opposite Directions (Going Straight)'),
    (82, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN INTO PATH: Turn Into Opposite Directions (Turning Left)'),
    (83, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN INTO PATH: Turn Into Opposite Directions (Going Straight)'),
    (84, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN INTO PATH: Specifics Other'),
    (85, 'CHANGING TRAFFICWAY, VEHICLE TURNING - TURN INTO PATH: Specifics Unknown'),
    (86, 'INTERSECTING PATHS (VEHICLE DAMAGE) - STRAIGHT PATHS: Striking from the Right'),
    (87, 'INTERSECTING PATHS (VEHICLE DAMAGE) - STRAIGHT PATHS: Struck on the Right'),
    (88, 'INTERSECTING PATHS (VEHICLE DAMAGE) - STRAIGHT PATHS: Striking from the Left'),
    (89, 'INTERSECTING PATHS (VEHICLE DAMAGE) - STRAIGHT PATHS: Struck on the Left'),
    (90, 'INTERSECTING PATHS (VEHICLE DAMAGE) - STRAIGHT PATHS: Specifics Other'),
    (91, 'INTERSECTING PATHS (VEHICLE DAMAGE) - STRAIGHT PATHS: Specifics Unknown'),
